...
<div class="container-fluid">
	...
	<a href="<?= base_url('User/lihatdata/'); ?>" type="button" class="btn btn-info mb-3 mt-3"><i class="fas fa-eye"></i> Lihat Data</a>
	<br />
	<br />

	<div class="col-sm-12">
		<div class="card">
			<div class="card-header bg-info text-white">Tambah Data Peminjaman</div>
			<div class="card-body">
				<form class="form-horizontal" action="<?php echo base_url('User/user') ?>" method="post" enctype="multipart/form-data" role="form">
					<div class="modal-body">
						...
						<div class="form-group">
							<div class="col-lg">
								<input type="hidden" class="form-control" id="status" name="status" value="Pending" readonly>
							</div>
						</div>
